const en = {
	...
	shared_property_option_removal_blocked: 'Rename or remove shared options from a selector menu so the impact-aware migration workflows can protect existing values.',
	...
	selector_option_color_error: 'Unable to update the option color.',
	selector_option_delete_error: 'Unable to delete the option. Existing values were preserved or rolled back.',
	shared_manager_settings_name: 'Shared properties registry',
	shared_manager_settings_desc: 'Create and manage vault-wide properties without attaching them to a database first.',
	shared_manager_open: 'Manage shared properties',
	shared_manager_title: 'Shared properties',
	shared_manager_desc: 'Vault-wide definitions stored in register_shared_propertiers.md.',
	shared_manager_loading: 'Analyzing the registry, databases, and note values…',
	shared_manager_load_error: 'Unable to load the shared-properties registry.',
	shared_manager_empty: 'No shared property exists yet.',
	shared_manager_usage: '$databases database(s) · $notes note(s) with a value',
	shared_manager_unattached: 'Not attached to any database.',
	shared_manager_open_database: 'Open database',
	shared_manager_broken_title: 'Broken references',
	shared_manager_broken_desc: 'These databases reference definitions that are missing from the registry.',
	shared_manager_clean_reference: 'Remove reference',
	shared_manager_clean_error: 'Unable to remove the broken reference.',
