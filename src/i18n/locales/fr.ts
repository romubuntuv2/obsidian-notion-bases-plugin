...
const fr: Partial<Record<keyof typeof en, string>> = {
	...
	shared_property_option_removal_blocked: 'Renomme ou supprime les options partagées depuis un menu de sélecteur afin d’utiliser les workflows de migration qui protègent les valeurs existantes.',
	...
	selector_option_color_error: 'Impossible de modifier la couleur de l’option.',
	selector_option_delete_error: 'Impossible de supprimer l’option. Les valeurs existantes ont été préservées ou restaurées.',
	shared_manager_settings_name: 'Registre des propriétés partagées',
	shared_manager_settings_desc: 'Créer et administrer les propriétés du vault sans devoir d’abord les attacher à une base.',
	shared_manager_open: 'Gérer les propriétés partagées',
	shared_manager_title: 'Propriétés partagées',
	shared_manager_desc: 'Définitions communes au vault stockées dans register_shared_propertiers.md.',
	shared_manager_loading: 'Analyse du registre, des bases et des valeurs des notes…',
	shared_manager_load_error: 'Impossible de charger le registre des propriétés partagées.',
	shared_manager_empty: 'Aucune propriété partagée n’existe pour le moment.',
	shared_manager_usage: '$databases base(s) · $notes note(s) avec une valeur',
	shared_manager_unattached: 'Attachée à aucune base.',
	shared_manager_open_database: 'Ouvrir la base',
	shared_manager_broken_title: 'Références cassées',
	shared_manager_broken_desc: 'Ces bases référencent des définitions absentes du registre.',
	shared_manager_clean_reference: 'Retirer la référence',
	shared_manager_clean_error: 'Impossible de retirer la référence cassée.',
